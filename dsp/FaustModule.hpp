 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fRec2[0] * std::sin(fConst4 * fRec0[0]);
			float fTemp3 = fConst3 * (fRec0[0] * std::pow(1e+01f, 0.05f * std::fabs(fRec1[0])) / fTemp2);
			float fTemp4 = fConst3 * (fRec0[0] / fTemp2);
			...
			float fTemp15 = fRec6[0] * std::sin(fConst4 * fRec4[0]);
			float fTemp16 = fConst3 * (fRec4[0] * std::pow(1e+01f, 0.05f * std::fabs(fRec5[0])) / fTemp15);
			float fTemp17 = fConst3 * (fRec4[0] / fTemp15);
			...
			float fTemp28 = fRec10[0] * std::sin(fConst4 * fRec8[0]);
			float fTemp29 = fConst3 * (fRec8[0] * std::pow(1e+01f, 0.05f * std::fabs(fRec9[0])) / fTemp28);
			float fTemp30 = fConst3 * (fRec8[0] / fTemp28);
